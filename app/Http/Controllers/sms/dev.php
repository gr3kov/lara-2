...
?>
<p>В этом премере дата последнего считывания sms хранится в переменной сессии. Правильным решением при реализации
    будет хранение даты в базе данных. Считывается 5 входящих sms с даты приёма последней считанной sms.</p>
<?php
...
//загружаем входящие сообщения
    ...
    <table style="border:1px dotted silver; margin-top:30px;">
        ...
        <tbody>
        <?php foreach ($arMassiv as $arIndex):
