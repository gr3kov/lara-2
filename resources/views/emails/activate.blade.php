    ...
    <tr>
        <td style="{{ $style['email-wrapper'] }}" align="center">
            <table width="100%" cellpadding="0" cellspacing="0">
                <!-- Logo -->
                <tr>
                    <td style="{{ $style['email-masthead'] }} background-color:white;">
                        <a style="{{ $fontFamily }} {{ $style['email-masthead_name'] }}" href="{{ url('/') }}" target="_blank">
                            {{--<img style="height:50%" src="{{ url('/') }}/images/logo-short.png">--}}
                ...
                <tr>
                    <td>
                        <table style="{{ $style['email-footer'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                            <tr><br><br><b><a href="https://Flame Auctoinonline.ru/email/unsubscribe?name=" . {{ $name }}>Отписаться</a></b></tr>
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}">
                                    <p style="{{ $style['paragraph-sub'] }} font-size: 13px;">
                                        &copy; 2019-{{ date('Y') }}
                                       Flame Auction Online
                                    </p>
                                </td>
                            </tr>
                        </table>
